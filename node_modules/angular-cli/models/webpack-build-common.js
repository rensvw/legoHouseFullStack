 ...
 * require('file-loader')
 */
function getWebpackCommonConfig(projectRoot, environment, appConfig, baseHref, sourcemap, vendorChunk, verbose, progress, outputHashing, extractCss) {
    ...
    if (!appConfig.styles || appConfig.styles.length === 0) {
        ...
        if (extractCss && extractedCssEntryPoints_1.length > 0) {
